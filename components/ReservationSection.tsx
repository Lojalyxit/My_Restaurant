  ...
  return (
    <section id="reservation" className="section-padding bg-espresso" ref={ref}>
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8, delay: 0.2 }} className="bg-ivory p-10">
          {success ? (
            <div className="text-center py-8">
              ...
              <p className="text-espresso/70 font-inter">Nous vous confirmerons par email sous 24h.<br />Au plaisir de vous accueillir chez Louise.</p>
              <button onClick={() => setSuccess(false)} className="btn-gold mt-8">Nouvelle réservation</button>
            </div>
          ) : (
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <textarea {...register('message')} placeholder="Allergies, occasion spéciale... (optionnel)" rows={4} className={inputCls} />
